...
days_back = os.environ.get('DT_FILTER')

# get the service resource
dynamodb = boto3.resource('dynamodb', region_name = str(aws_region))

# instantiate a table resource object 
table = dynamodb.Table(str(dynamodb_table))

# set date filter
dt_limit = str(datetime.datetime.now() - datetime.timedelta(days=int(days_back)))
